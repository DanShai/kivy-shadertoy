...
from fwidgets.utils import get_rgba_color as get_color
...
class FTextInput( MCodeInput):
    ...
    def __init__(self, **kwargs):
        ...
        self.font_size = '32dp'
        self.font_name =  './fwidgets/data/font/fsix.ttf'
    ...
    def center_text(self):
        ...
        # top, bottom
        self.padding_y = [self.height - (self.line_height ) * len(self._lines), 0]
